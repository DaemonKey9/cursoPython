    ...
    public void blockgen(){
      ...
      public void rotate(){
        ...
        if((perim[2+centralx+prof[pos[0]][0][rand-1].x][centraly+prof[pos[0]][0][rand-1].y+2]!=4)
           ...
           && (perim[2+centralx+prof[pos[0]][1][rand-1].x][centraly+prof[pos[0]][1][rand-1].y+2] !=4)
           && (perim[2+centralx+prof[pos[0]][1][rand-1].x][centraly+prof[pos[0]][1][rand-1].y+2] !=1)
           && (perim[2+centralx+prof[pos[0]][1][rand-1].x][centraly+prof[pos[0]][1][rand-1].y+2] !=2)
           && (perim[2+centralx+prof[pos[0]][1][rand-1].x][centraly+prof[pos[0]][1][rand-1].y+2] !=3)
           && (perim[2+centralx+prof[pos[0]][2][rand-1].x][centraly+prof[pos[0]][2][rand-1].y+2] !=4)
           && (perim[2+centralx+prof[pos[0]][2][rand-1].x][centraly+prof[pos[0]][2][rand-1].y+2] !=1)
           && (perim[2+centralx+prof[pos[0]][2][rand-1].x][centraly+prof[pos[0]][2][rand-1].y+2] !=2)
           && (perim[2+centralx+prof[pos[0]][2][rand-1].x][centraly+prof[pos[0]][2][rand-1].y+2] !=3)
           && (perim[2+centralx+prof[pos[0]][3][rand-1].x][centraly+prof[pos[0]][3][rand-1].y+2] !=4)
           && (perim[2+centralx+prof[pos[0]][3][rand-1].x][centraly+prof[pos[0]][3][rand-1].y+2] !=1)
           && (perim[2+centralx+prof[pos[0]][3][rand-1].x][centraly+prof[pos[0]][3][rand-1].y+2] !=2)
           && (perim[2+centralx+prof[pos[0]][3][rand-1].x][centraly+prof[pos[0]][3][rand-1].y+2] !=3)){
